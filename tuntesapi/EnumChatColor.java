...
public enum EnumChatColor
{
    ...
    private EnumChatColor(char par3)
    {
        this(par3, false);
    }

    private EnumChatColor(char par3, boolean par4)
    {
    ...
    public static EnumChatColor func_96300_b(String par0Str)
    {
        return par0Str == null ? null : (EnumChatColor)field_96331_x.get(par0Str.toLowerCase());
    }
