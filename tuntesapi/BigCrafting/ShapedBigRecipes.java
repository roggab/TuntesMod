...
public class ShapedBigRecipes implements IRecipe
{
    ...
    public ShapedBigRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    {
        for (int var3 = 0; var3 <= 9 - recipeWidth; ++var3)
        {
            for (int var4 = 0; var4 <= 9 - recipeHeight; ++var4)
            {
    ...
    public ShapedBigRecipes func_92100_c()
    {
